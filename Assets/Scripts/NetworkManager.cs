...
namespace Sanicball
{
    public class NetworkManager : MonoBehaviour
    {
        ...
        {   
            ...
            SanicLogger.NormalLog += Debug.Log;
            SanicLogger.DebugLog += Debug.Log;
            SanicLogger.WarnLog += Debug.LogWarning;
            SanicLogger.ErrorLog += Debug.LogError;
            instance = this;
        }
        ...
        public static bool StartServer(string serverName, int maxPlayers, int port, bool useNat, bool showOnList, out string error)
        {
            try
            {
        ...
        private static void CreateServerConfig(string serverName, int maxPlayers, int port, bool showOnList)
        {
            ...
            var ip = new WWW("http://ipinfo.io/ip");
            while (!ip.isDone || ip.error == "")
            {

            }
            config.PublicIP = ip.text.Trim();
